import { View, Text, StatusBar, StyleSheet,Button,ToastAndroid,Alert, TextInput, TouchableOpacity, Image,ScrollView } from 'react-native';
...
export default function Login({navigation}) {
  ...
  const offlineLogin = ()=>{
    if(email.length == 0){
      ToastAndroid('Please input username')
    }
  }
  return (
