      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            style={styles.socials}
          >
          <Image style={{width:25, height:25, marginLeft:25}} source={require('../assets/images/facebook.png')} />
          <Text style={{width:'80%', textAlign:'center', fontSize:16}}>Sign in with Facebook</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.socials}
          >
          <Image style={{width:25, height:25, marginLeft:25}} source={require('../assets/images/twitter.png')} />
