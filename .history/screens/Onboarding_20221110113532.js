  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Button navigation={navigation} text='Get Started' name='arrow-right' loc="Login"/>
          
          <TouchableOpacity
            onPress={()=>{navigation.replace('LoginBiz')}}
            style={{
          ...
          >
            ...
            >
              Rent A Store <AntDesign size={20} style={{fontWeight:900}} name='isv'/>
            </Text>
          </TouchableOpacity>
        </View>
      </View>
