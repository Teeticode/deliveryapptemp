...
const CartComment =({restaurant,setwComment, wcomment})=>(
    ...
    >
        ...
        <View>
            {(wcomment==='comment')?<MaterialCommunityIcons name='multiplication' style={{fontSize:30, color:'lightgray', borderColor:'black'}}/>:<MaterialCommunityIcons name='cart' style={{fontSize:30, color:'lightgray', borderColor:'black'}}/>}
